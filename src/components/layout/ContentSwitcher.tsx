...
export const ContentSwitcher: React.FC<ContentSwitcherProps> = ({
  ...
  return (
    <div className="px-5 mb-3 select-none">
      <div className="h-10 flex items-center bg-black/[0.04] dark:bg-white/[0.05] p-1 rounded-xl border border-black/[0.04] dark:border-white/[0.06]">
        <button
          type="button"
          onClick={() => onSelected("todos")}
          className={`flex-1 h-full flex items-center justify-center text-xs font-semibold rounded-lg transition-all mui-ripple cursor-pointer ${
            selected === "todos"
